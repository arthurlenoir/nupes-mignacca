...
export const supporters: SupporterType[] = [
  ...
  },
  {
    ...
    message: "Je soutiens sans faille la candidature de Julia Mignacca , Écologiste face à l'urgence écologique, au réchauffement climatique et à la crise sociale. Aucune voix de  ne doit lui manquer dimanche.",
  },
  {
    firstName: "Yassine",
    lastName: "Chaanane",
  ...
  },
  {
    ...
    message: "Julia Mignacca a tout mon soutien. Elle porte cette union de la gauche si longtemps désirée et aujourd'hui réussie !",
  },
  {
    firstName: "Aurélie",
    lastName: "Santini",
    ...
    message: "Je suis fière d'entendre enfin une candidate parler des problèmes du quotidien, de toutes ces injustices que nous subissons ! Il faut des députées comme Julia contre Macron et son monde !",
  },
  {
    firstName: "José-Jean",
    ...
    city: "Saussines",
    occupation: "Tehatreu",
    message: "Parce que  nous n'avons plus le choix ... vite vite un  monde  meilleur pour cela je compte sur toi Julia avec tout mon soutien. ",
  },
  {
    firstName: "Thierry",
    lastName: "Jalras",
    city: "Castelnau-le-Lez",
    occupation: "Professeur agrégé de mathématiques et d'informatique · ingénieur civil des mines",
